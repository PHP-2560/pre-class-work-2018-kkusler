...
#The information necessary to construct the histogram is saved in big.hist
...
#The histogram is problem 5b was plotting a histogram of the distribution, while the histogram in problem 5f is plotting a histogram of the means of a distribution. The histogram in 5f is approximately normally distributed, as we would expect from the Central Limit Theorem.
```
